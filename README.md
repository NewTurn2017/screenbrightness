...
| **away** 🌙 | Keep awake + screen **off now** (display sleep). |
...
- **Display sleep / sleep:** `pmset displaysleepnow` / `pmset sleepnow`.
...
- **화면/시스템 재우기:** `pmset displaysleepnow` / `pmset sleepnow`.
